...
namespace Mathmagician.Tests
{
    ...
    public class TerminalTests
    {
        ...
        [TestMethod]
        public void TerminalFirstQuestionBadUserInput()
        {
            //Arrange
            Terminal term = new Terminal();
            ...
            string actual_output = term.AcceptFirstAnswer("car");
        ...
        public void TerminalUserNeedsHelp()
        {
            ...
            string expected_output = "I only understand: Even, Prime, Odd, Fibonacci and Integer.";
